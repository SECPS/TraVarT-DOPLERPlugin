...
>|$a_2$|$a_2$?|Boolean|false \| true||$rules(a_1)$|$visibility(a_2)$
>|...|...|...|...|||...
>|$a_n$|$a_n$?|Boolean|false \| true||$rules(a_1)$|$visibility(a_n)$

> ### Rule 1.2: Alternative Group
>  Be $G$ an alternative group
>  Be $a$ the parent feature of $G$
> B $a_1$, $a_2$, ..., $a_n$ children of $G$
> Then one one enumeration decision is created
