...
/**
 * A {@code RangeValueException} indicates that while setting the value of a decision an error occurred. This means that
 * either, the given RangeValue is not part of the Range of the decision or RangeValue was set even though it was
 * disabled.
 *
 * @author Kevin Feichtinger
 */
