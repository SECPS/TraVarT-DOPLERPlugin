...
public class NoActionInRuleException extends ParserException {
    ...
    /**
     * Creates a new NoActionInRuleException parser exception with the given message.
     *
    ...
    /**
     * Creates a new NoActionInRuleException parser exception with the given sub exception.
     *
