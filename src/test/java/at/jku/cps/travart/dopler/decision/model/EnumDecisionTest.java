...
public class EnumDecisionTest {
    ...
    public void getValueTest() throws RangeValueException {
        ...
        //		};
        //		assertThrows(
        //				"There is no value set for the decision yet, so this should throw an exception when trying to
        //				find oen",
    ...
    public void testGetCardinality() {
        EnumerationDecision d = new EnumerationDecision("test");
        assertEquals(new Cardinality(0, 1), d.getCardinality(),
                d.getCardinality() + " should equal " + new Cardinality(0, 1));
