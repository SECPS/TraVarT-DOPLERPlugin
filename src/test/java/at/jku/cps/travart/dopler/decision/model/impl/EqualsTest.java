...
public class EqualsTest {
	...
	public void testEqualsGetValueFunctionAndGetValueFunctionNumbers1() throws RangeValueException {
		...
		e = new Equals(gvf1, gvf2);
		assertFalse(gvf1.getDecision().getValue() + " == " + gvf2.getDecision().getValue() + " should be false",
				e.evaluate());
	}
	...
	public void testEqualsGetValueFunctionAndGetValueFunctionNumbers2() throws RangeValueException {
		...
		assertFalse(gvf2.getDecision().getValue() + " == " + gvf1.getDecision().getValue() + " should be false",
				e.evaluate());
	}
	...
	public void testEvaluateFalseFalse() {
		...
		assertFalse("Should return true, because two false are not comparables!", e.evaluate());
	}
