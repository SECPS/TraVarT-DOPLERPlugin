...
public class DecisionModel2Test {
	...
	public void testGetCurrentConfigurationCorrect() {
		...
		assertEquals(controlMap.toString() + " should equal " + dm.getCurrentConfiguration().toString(), controlMap,
				dm.getCurrentConfiguration());
		bd.setSelected(false);
		assertNotEquals(controlMap.toString() + " should not equal " + dm.getCurrentConfiguration().toString(),
				controlMap, dm.getCurrentConfiguration());
	}
