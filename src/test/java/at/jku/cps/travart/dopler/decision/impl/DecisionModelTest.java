...
//	}
	...
	public void testSetDecisionValue() throws ActionExecutionException, RangeValueException {
		...
		ThrowingRunnable run = () -> d2.setValue(s3.getValue());
...
//	}
	...
	public void testFindString() {
		...
		dm.add(d);
		dm.add(b);
		assertEquals("d is in the model and should be found.", d, dm.get(d.getId()));
		assertEquals("b is in the model and should be found.", b, dm.get(b.getId()));
		assertNull("dn has not been added to the model and should not be found.", dm.get(dn.getId()));
	}
